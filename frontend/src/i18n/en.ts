...
export const en: Messages = {
  ...
  status: {
    ...
    descNoInstance: 'No active instance. Create one from the instance tabs / "+" button to start a terminal session.',
  ...
  shortcuts: {
    ...
    groupDescPlaceholder: 'Optional, shown above the list when expanded',
  ...
  files: {
    title: 'Files',
    openTooltip: 'Browse files',
    breadcrumbRoot: 'Working directory',
    toolbarUp: 'Up',
    toolbarCwd: 'Back to cwd',
    ...
    previewBinary: 'Preview unavailable for this file type',
    ...
    previewWrap: 'Wrap',
    previewViewSource: 'View source',
    previewViewRendered: 'View rendered',
    htmlRenderWarn: 'This HTML will be rendered as a web page. Choose how to render it:',
    htmlRenderSandbox: 'Sandboxed (recommended)',
    htmlRenderDanger: 'Dangerous mode',
    previewCloseAll: 'Close all',
    previewCloseAllConfirmTitle: 'Close all previews?',
    previewCloseAllConfirmMsg: 'All open file previews will be closed. The source file list and settings are unaffected.',
    previewStackView: 'Preview stack',
