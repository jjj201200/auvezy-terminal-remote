...
export const zhCN: Messages = {
  ...
  status: {
    ...
    descNoInstance: '当前没有 active 实例。从实例 tabs 的"+"按钮创建一个,即可开启终端会话。',
  ...
  shortcuts: {
    ...
    groupDescPlaceholder: '可选，展开分组时显示在列表上方',
  ...
  files: {
    ...
    previewLoading: '加载中…',
    previewWrap: '自动换行',
    previewViewSource: '查看源码',
    previewViewRendered: '查看渲染',
    htmlRenderWarn: '此 HTML 将作为网页渲染。请选择渲染方式：',
    htmlRenderSandbox: '沙箱模式（推荐）',
    htmlRenderDanger: '危险模式',
    previewCloseAll: '全部关闭',
    previewCloseAllConfirmTitle: '关闭所有预览?',
    previewCloseAllConfirmMsg: '将关闭当前打开的全部文件预览,源文件列表与设置不受影响。',
    previewStackView: '预览栈',
